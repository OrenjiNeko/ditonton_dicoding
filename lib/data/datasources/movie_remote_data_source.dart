...
class MovieRemoteDataSourceImpl implements MovieRemoteDataSource {
  ...
  MovieRemoteDataSourceImpl({required this.client, this.useSSL = true});
  ...
  Future<MovieDetailResponse> getMovieDetail(int id) async {
    final secureClient = await _getClient();
    final response =
        await secureClient.get(Uri.parse('$BASE_URL/movie/$id?$API_KEY'));
  ...
  Future<List<MovieModel>> getPopularMovies() async {
    final secureClient = await _getClient();
    final response =
        await secureClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY'));
  ...
  Future<List<MovieModel>> getTopRatedMovies() async {
    final secureClient = await _getClient();
    final response =
        await secureClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY'));
