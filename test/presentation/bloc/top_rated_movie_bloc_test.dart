...
void main() {
  late GetTopRatedMovieBloc getTopRatedMoviesBloc;
  late MockGetTopRatedMovies mockGetTopRatedMovies;

  setUp(() {
    mockGetTopRatedMovies = MockGetTopRatedMovies();
    getTopRatedMoviesBloc = GetTopRatedMovieBloc(mockGetTopRatedMovies);
  });

  test('initial state should be empty', () {
    expect(getTopRatedMoviesBloc.state, GetTopRatedMoviesEmpty());
  });
  ...
  blocTest<GetTopRatedMovieBloc, GetTopRatedMovieState>(
